...
export const Route = createFileRoute("/changelog")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Changelog for Minimal bookmark manager",
      },
    ],
  }),
...
const changelog: ChangelogVersion[] = [
  {
    ...
    added: [
      {
        text: "Multi-source bookmark capture with dedupe and source routing",
        pr: 57,
      },
  ...
  },
  {
    ...
    changed: [{ text: "Simplified email call sites and settings dialog" }],
    fixed: [
      {
        text: "Twitter profile pictures showing generic X favicon instead of actual avatars",
        pr: 50,
      },
      { text: "Consistent paragraph spacing in email templates", pr: 50 },
      {
        text: "Dashboard UI spacing, empty state, and dialog close buttons",
        pr: 50,
      },
  ...
  },
  {
    ...
    added: [
      {
        text: "Multi-select functionality with keyboard and mouse support for bulk operations",
        pr: 41,
      },
      ...
      {
        text: "Settings dialog with profile management and name editing",
        pr: 35,
      },
      {
        text: "Claude Code GitHub workflows for automated PR assistance and code review",
        pr: 40,
      },
      {
        text: "Split dashboard into separate route with cached landing page for better performance",
        pr: 36,
      },
