...
const base = [
  ...
  // Border
  "border border-stone-950/15 group-data-[checked]:border-transparent group-data-[checked]:group-data-[hover]:border-transparent group-data-[hover]:border-stone-950/30 group-data-[checked]:bg-[--checkbox-checked-border]",
  ...
  "group-data-[disabled]:border-stone-950/25 group-data-[disabled]:bg-stone-950/5 group-data-[disabled]:[--checkbox-check:theme(colors.stone.950/50%)] group-data-[disabled]:before:bg-transparent",
...
const colors = {
  "dark/stone": [
    "[--checkbox-check:theme(colors.white)] [--checkbox-checked-bg:theme(colors.stone.900)] [--checkbox-checked-border:theme(colors.stone.950/90%)]",
    "dark:[--checkbox-checked-bg:theme(colors.stone.600)]",
  ],
  "dark/white": [
    "[--checkbox-check:theme(colors.white)] [--checkbox-checked-bg:theme(colors.stone.900)] [--checkbox-checked-border:theme(colors.stone.950/90%)]",
    "dark:[--checkbox-check:theme(colors.stone.900)] dark:[--checkbox-checked-bg:theme(colors.white)] dark:[--checkbox-checked-border:theme(colors.stone.950/15%)]",
  ],
  white:
    "[--checkbox-check:theme(colors.stone.900)] [--checkbox-checked-bg:theme(colors.white)] [--checkbox-checked-border:theme(colors.stone.950/15%)]",
  dark: "[--checkbox-check:theme(colors.white)] [--checkbox-checked-bg:theme(colors.stone.900)] [--checkbox-checked-border:theme(colors.stone.950/90%)]",
  stone:
    "[--checkbox-check:theme(colors.white)] [--checkbox-checked-bg:theme(colors.stone.600)] [--checkbox-checked-border:theme(colors.stone.700/90%)]",
