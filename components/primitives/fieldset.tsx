...
export function Legend({ className, ...props }: { className?: string } & Omit<Headless.LegendProps, "className">) {
  return (
    <Headless.Legend
      ...
      className={clsx(
        className,
        "text-base/6 font-semibold text-stone-950 data-[disabled]:opacity-50 sm:text-sm/6 dark:text-white"
      )}
    />
  );
}
...
export function Label({ className, ...props }: { className?: string } & Omit<Headless.LabelProps, "className">) {
  return (
    <Headless.Label
      ...
      className={clsx(
        className,
        "select-none text-base/6 text-stone-950 data-[disabled]:opacity-50 sm:text-sm/6 dark:text-white"
      )}
    />
  );
}
...
export function Description({
  ...
  return (
    <Headless.Description
      ...
      className={clsx(
        className,
        "text-base/6 text-stone-500 data-[disabled]:opacity-50 sm:text-sm/6 dark:text-stone-400"
      )}
    />
  );
}
